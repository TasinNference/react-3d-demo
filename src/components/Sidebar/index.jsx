...
const DraggableItem = forwardRef(({img, dragHandleProps, draggableProps, apiUrl, index, toggleImageVisibility}, ref) => {
  return (
    <LayersItem ref={ref} {...draggableProps}>
      ...
      <ItemHeader>
        ...
        <ItemIconsContainer>
          <IconButton size="small" onClick={() => toggleImageVisibility(index)}>
      ...
      <ItemContent>
        ...
        <ItemAdjustmentContainer>
          ...
          <Typography variant="caption">X move</Typography>
          <Typography variant="caption">Y move</Typography>
...
const Sidebar = ({ data, handleDragEnd, apiUrl, toggleImageVisibility }) => {
  console.log(data)
